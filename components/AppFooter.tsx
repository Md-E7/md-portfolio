const AppFooter = (): JSX.Element => {
  return (
    <footer className={'flex w-full flex-col items-center justify-center gap-2 bg-white p-3 dark:bg-slate-800'}>
      <div className={'flex items-center gap-2'}>
        <a href="https://github.com/md-e7" className={'rounded-full p-1 transition ease-in-out hover:scale-105 hover:bg-slate-200 dark:hover:bg-slate-800'}>
          <svg className="h-7 w-7 dark:fill-white" viewBox="0 0 128 128">
            <title>Github</title>
            <g>
      ...
      <p className={'text-center text-sm font-medium text-slate-500'}>Dibuat oleh Md-E7 menggunakan Next.js dan TailwindCSS</p>
    </footer>
  )
}
